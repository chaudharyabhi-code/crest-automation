...
import { compareHoldingsCount } from '../../../utils/family/testHelpers.js';
import { familyAnalysisEndpoints as analysisEndpoints } from '../../../endpoints/index.js';

test.describe('Analysis Holdings Count Tests (Family)', () => {
  ...
  test('All Assets Holdings Count', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.holdingsCount(familyId));
    ...
    const result = await compareHoldingsCount({
      apiCount: apiCount,
      sqlFilePath: 'family/holdings_count-Analysis_tab.sql',
      familyId: familyId,
      filterClass: 'ALL',
  ...
  test('Equity Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.equityHoldingsCount(familyId));
  ...
  test('Mutual Fund Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.mfHoldingsCount(familyId));
  ...
  test('ETF Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.etfHoldingsCount(familyId));
  ...
  test('Cash and Bank Balance Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.bankBalanceHoldingsCount(familyId));
  ...
  test('Recurring Deposits Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.rdHoldingsCount(familyId));
  ...
  test('NPS Holdings Count with Filter', async ({ apiClient }) => {
    ...
    const response = await apiClient.get(analysisEndpoints.npsHoldingsCount(familyId));
