...
import { extractApiValue } from '../../../utils/family/testHelpers.js';
import { familyDashboardEndpoints as dashboardEndpoints } from '../../../endpoints/index.js';
import fs from 'fs';
import path from 'path';

test.describe('Holdings Count Tests (Family)', () => {
  ...
  test('Holdings Count Verification - Equity, MF, ETF', async ({ apiClient }) => {
    ...
    const sqlQuery = fs.readFileSync(
      path.join(process.cwd(), 'queries', 'family', 'holdings_count_test.sql'),
      'utf-8'
